...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAddClasses.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddClassesActionPerformed(evt);
            }
        });
    ...
    private void btnAddTeacherTeacherFormActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTeacherTeacherFormActionPerformed
        /*******KEITH's edit: Error handling*********/
        //boolean checkAge = false;
        //boolean checkSalary = false;
        //boolean checkTenure = false;

        if(
            txtFirstNameTeacherForm.getText().trim().isEmpty() || txtLastNameTeacherForm.getText().trim().isEmpty() || txtAgeTeacherForm.getText().trim().isEmpty() ||
            txtSalaryTeacherForm.getText().trim().isEmpty() || txtTenureTeacherForm.getText().trim().isEmpty() || txtDepartmentTeacherForm.getText().trim().isEmpty()){
                showMessageDialog(null, "Please do not leave a field blank", "Null error", ERROR_MESSAGE);
                return;
        }
            try{
                Integer.parseInt(txtAgeTeacherForm.getText());
                //checkAge = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid age", "Format error", ERROR_MESSAGE);
                return;
            }
            try{
                Double.parseDouble(txtSalaryTeacherForm.getText()); 
                //checkSalary = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid salary", "Format error", ERROR_MESSAGE);
                return;
            }
            try{
                Integer.parseInt(txtTenureTeacherForm.getText()); 
                //checkTenure = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid tenure", "Format error", ERROR_MESSAGE);
                return;
            }
        if(Integer.parseInt(txtAgeTeacherForm.getText())>200||Integer.parseInt(txtAgeTeacherForm.getText())<0){
            showMessageDialog(null, "Please enter a valid age [0-200]", "Invalid range", ERROR_MESSAGE);
            return;
        }
        /************** End of Edit ****************/
        ...
        //cboC1Prof.addItem(newTeacher.getFirstName() + " " + newTeacher.getLastName());
    ...
    private void btnAddCounselorCounselorFormActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCounselorCounselorFormActionPerformed
        ...
        if(
            txtFirstNameCounselorForm.getText().trim().isEmpty() || txtLastNameCounselorForm.getText().trim().isEmpty() || txtAgeCounselorForm.getText().trim().isEmpty() || 
            txtSalaryCounselorForm.getText().trim().isEmpty() || txtTenureCounselorForm.getText().trim().isEmpty() || txtStudentsCounselorForm.getText().trim().isEmpty()){
                showMessageDialog(null, "Please do not leave a field blank", "Null error", ERROR_MESSAGE);
                return;
        }
            try{
                Integer.parseInt(txtAgeCounselorForm.getText()); 
                //checkAge = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid age", "Format error", ERROR_MESSAGE);
            ...
            try{
                Double.parseDouble(txtSalaryCounselorForm.getText()); 
                //checkSalary = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid salary", "Format error", ERROR_MESSAGE);
            ...
            try{
                Integer.parseInt(txtTenureCounselorForm.getText()); 
                //checkTenure = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid tenure", "Format error", ERROR_MESSAGE);
            ...
            try{
                Integer.parseInt(txtStudentsCounselorForm.getText());
                //checkStudent = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid Student#", "Format error", ERROR_MESSAGE);
                return;
            }
            
        if(Integer.parseInt(txtAgeCounselorForm.getText())>200||Integer.parseInt(txtAgeCounselorForm.getText())<0){
            showMessageDialog(null, "Please enter a valid age [0-200]", "Invalid range", ERROR_MESSAGE);
            return;
        }
        /************** End of Edit ****************/
    ...
    private void btnAddStudentStudentFormActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddStudentStudentFormActionPerformed
        /*******KEITH's edit: Error handling*********/
        //boolean checkAge = false;
        //boolean checkGradYear = false;

        if(
            txtFirstNameStudentForm.getText().trim().isEmpty() || txtLastNameStudentForm.getText().trim().isEmpty() || txtAgeStudentForm.getText().trim().isEmpty() ||
            txtGradYearStudentForm.getText().trim().isEmpty() || txtMajorStudentForm.getText().trim().isEmpty()){
                showMessageDialog(null, "Please do not leave a field blank", "Null error", ERROR_MESSAGE);
                return;
        }
            try{
                Integer.parseInt(txtAgeStudentForm.getText());
                //checkAge = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a valid age", "Format error", ERROR_MESSAGE);
            ...
            try{
                Integer.parseInt(txtGradYearStudentForm.getText()); 
                //checkGradYear = true;
            }
            catch(NumberFormatException e){
                showMessageDialog(null, "Please enter a Graduation Year", "Format error", ERROR_MESSAGE);
                return;
            }
        if(Integer.parseInt(txtAgeStudentForm.getText())>200||Integer.parseInt(txtAgeStudentForm.getText())<0){
            showMessageDialog(null, "Please enter a valid age [0-200]", "Invalid range", ERROR_MESSAGE);
            return;
        }
        if(cboCurYearStudentForm.getSelectedIndex()== -1){
            showMessageDialog(null, "Please select a year from the dropdown menu", "Invalid Selection", ERROR_MESSAGE);
            return;
        }
        /************** End of Edit ****************/
    ...
    private void cboC1DptProfFinder(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboC1DptProfFinder
       ...
       for(int ctr = 1; ctr <= DataBase.getTeacherList().size(); ctr++)
       {
           if(cboC1Dpt.getSelectedItem().equals(DataBase.teacherIDLookUp("T" + ctr).getDepartment()))
           {    
               System.out.println(ctr);
               //System.out.println(DataBase.teacherIDLookUp("T" + ctr).getFirstName());
               cboC1Prof.addItem(DataBase.teacherIDLookUp("T" + ctr).getLastName() + ", " + DataBase.teacherIDLookUp("T" + ctr).getFirstName());
           }
       }
    ...
    private void btnAddClassesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddClassesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnAddClassesActionPerformed
